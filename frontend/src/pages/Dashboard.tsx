    ...
    <div className="min-h-screen bg-caky-bg">
      ...
      <header className="border-b border-caky-text/10 bg-caky-card/80 backdrop-blur-md sticky top-0 z-10 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-3 md:py-4 flex justify-between items-center">
          <Link to="/" className="text-lg md:text-xl font-bold text-caky-primary flex items-center gap-2">
            <img src="/caky_logo.png" alt="Caky Logo" className="w-7 h-7 md:w-8 md:h-8 object-contain" />
            Caky
          </Link>
